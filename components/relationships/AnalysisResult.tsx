...
import { Card, Title, Paragraph, ProgressBar, List, Chip } from 'react-native-paper';
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      {analysis.mbtiCompatibility && (
        <Card style={styles.card}>
          <Card.Content>
            <Title>MBTI 性格匹配</Title>
            <ProgressBar
              progress={analysis.mbtiCompatibility.score / 100}
              color={getScoreColor(analysis.mbtiCompatibility.score)}
              style={styles.progressBar}
            />
      ...
      {analysis.astroCompatibility && (
        <Card style={styles.card}>
          <Card.Content>
            <Title>星座合盘分析</Title>
            <ProgressBar
              progress={analysis.astroCompatibility.score / 100}
              color={getScoreColor(analysis.astroCompatibility.score)}
              style={styles.progressBar}
            />
      ...
      {analysis.purpleStarCompatibility && (
        <Card style={styles.card}>
          <Card.Content>
            <Title>紫微斗数合盘分析</Title>
            <ProgressBar
              progress={analysis.purpleStarCompatibility.score / 100}
              color={getScoreColor(analysis.purpleStarCompatibility.score)}
              style={styles.progressBar}
            />
